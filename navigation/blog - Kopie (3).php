...
<div class="blogbeitrag">
    <section>
        ...
        if ($articleName && file_exists($markdownFile)) {
            ...
            // Artikel-Navigation mit einfachen Pfeilen
            echo '<div class="article-navigation">';
            if ($prevArticle) {
                echo '<a href="/navigation/blog.php?article=' . urlencode($prevArticle['file']) . '" class="nav-arrow">←</a>';
            } else {
                echo '<div></div>';
            }
            
            if ($nextArticle) {
                echo '<a href="/navigation/blog.php?article=' . urlencode($nextArticle['file']) . '" class="nav-arrow">→</a>';
            } else {
                echo '<div></div>';
            }
            echo '</div>';
