...
<div class="blogbeitrag">
    <section>
        ...
        if ($articleName && file_exists($markdownFile)) {
            ...
            if ($nextArticle) {
                echo '<a href="/navigation/blog.php?article=' . urlencode($nextArticle['file']) . '" class="nav-link">';
                echo '<span class="nav-link-text">← Neuerer Blogbeitrag</span>';
                echo htmlspecialchars($nextArticle['title']);
                echo '</a>';
            } else {
                echo '<div></div>';
            }
            ...
            if ($prevArticle) {
                echo '<a href="/navigation/blog.php?article=' . urlencode($prevArticle['file']) . '" class="nav-link next">';
                echo '<span class="nav-link-text">Älterer Blogbeitrag →</span>';
                echo htmlspecialchars($prevArticle['title']);
                echo '</a>';
            }
            echo '</div>';
